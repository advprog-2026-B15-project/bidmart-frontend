...
export const ITEMS: AuctionItem[] = [
  ...
  { id: 'L05', title: "Charizard Holo 1st Edition Base Set PSA 8 — Sealed pack",
    ...
    art: 'bm-art-toys', cat: 'coll', seller: 'rare_cards_jkt', rating: 5, ratingCount: 215,
...
export const TXNS: Transaction[] = (() => {
  ...
  const rows = [
    ...
    { type: 'Bid Hold', desc: 'Charizard PSA 8 — bid Rp 68.500.000',                  amount: -68_500_000, d: 3 },
    { type: 'Refund',   desc: 'Bid release · Outbid on Charizard PSA 8',               amount: +68_500_000, d: 3.6 },
    { type: 'Top Up',   desc: 'Mandiri Virtual Account · 88909233',                    amount: +10_000_000, d: 4 },
    ...
    { type: 'Top Up',   desc: 'OVO Wallet · 0812-3344-5566',                           amount: +1_500_000,  d: 12 },
    ...
    { type: 'Payment',  desc: 'Pembayaran #BM-2024-03889 — Vintage Walkman',           amount: -3_400_000,  d: 22 },
